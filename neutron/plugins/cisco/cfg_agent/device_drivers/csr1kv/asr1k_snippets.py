...
<config>
        <cli-config-data>
            <cmd>no ip nat inside source static %s %s vrf %s redundancy \
                neutron-hsrp-grp-%s-%s</cmd>
        </cli-config-data>
</config>
...
# eg:$(config)ip route vrf nrouter-e7d4y5 0.0.0.0 \
#     0.0.0.0 po10.304 10.0.100.255
# ===========================================================================#
...
# eg: $(config)ip nat pool TEST_POOL 192.168.0.20 \
...
#     <netmask_value>
# eg: $(config)no ip nat pool TEST_POOL 192.168.0.20 \
#     192.168.0.35 netmask 255.255.0.0
# ======================================================================#
DELETE_NAT_POOL = """
<config>
